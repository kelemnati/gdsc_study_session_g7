...
import 'package:gdsc_bookstore/horizontalscrollView.dart';

class BookDeatils extends StatefulWidget {
  const BookDeatils({super.key, required this.path, required this.title});
  final String path;
  final String title;

  @override
  State<BookDeatils> createState() => _BookDeatilsState();
}

class _BookDeatilsState extends State<BookDeatils> {
  @override
          ...
          children: [
            ...
            Padding(
              ...
              child: Column(children: [
                ...
                const SizedBox(
                  height: 300,
                  child: HorizontalScroll(bookTitle: [
                    'book-1',
                    'book-2',
                    'book-3'
                  ], images: [
